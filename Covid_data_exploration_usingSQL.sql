-- Quick scan through the dataset

select * 
from Covid_data
order by Location, date

-- Current cases in every country
...
-- Current infected percent and dead percent in every country
...
-- Fully vaccinated percent in every country in Asia
...
-- Create table to show vaccine percent in every country and plot in PowerBI
...
-- Infected percent and vaccinated percent by day
...
-- Create view to visual current vaccinated_percent
